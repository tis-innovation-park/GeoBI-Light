...
class TranslationController extends Controller {
    ...
    /**
     * @Route("/{lang}/{name}.json", requirements={"lang" = "en|it|de", "name" = "(homepage|app|user|map|login|signup|thankyou|logout|passwordreset|reset)[\-\w]*"}, methods = {"GET"}, name="r3gis.app.translation.list")
